...
from pip_services4_postgres.persistence.PostgresPersistence import PostgresPersistence
...
class IdentifiablePostgresPersistence(PostgresPersistence):
    ...
    In basic scenarios child classes shall only override :func:`get_page_by_filter <pip_services4_postgres.persistence.IdentifiableJsonPostgresPersistence.get_page_by_filter>`,
    :func:`get_list_by_filter <pip_services4_postgres.persistence.IdentifiableJsonPostgresPersistence.get_list_by_filter>` or :func:`delete_by_filter <pip_services4_postgres.persistence.IdentifiableJsonPostgresPersistence.delete_by_filter>`
    ...
    def set(self, context: Optional[IContext], item: T) -> Optional[T]:
        ...
        self._logger.trace(context, "Set in %s with id = %s", self._quote_identifier(self._table_name),
                           item.id)
