...
pip_services4_sqlserver provides SqlServer persistence components.

Links
`````

* `website <http://github.com/pip-services/pip-services>`_
* `development version <http://github.com/pip-services4/pip-services4-python/tree/main/pip-services4--sqlserver-python>`
...
setup(
    name='pip_services4_sqlserver',
    version='0.0.1',
    url='http://github.com/pip-services4/pip-services4-python/tree/main/pip-services4--sqlserver-python',
    license='MIT',
