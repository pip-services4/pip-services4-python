...
* `development version <http://github.com/pip-services4-python/pip-services4-memcached-python>`
...
setup(
    ...
    version='0.0.1',
    url='http://github.com/pip-services4-python/pip-services4-memcached-python',
    license='MIT',
