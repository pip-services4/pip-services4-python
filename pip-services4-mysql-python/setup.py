...
* `development version <http://github.com/pip-services4/pip-services4-python/tree/main/pip-services4--mysql-python>`
...
setup(
    ...
    version='0.0.1',
    url='http://github.com/pip-services4/pip-services4-python/tree/main/pip-services4--mysql-python',
    license='MIT',
