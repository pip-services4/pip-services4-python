...
intersphinx_mapping = {'python': ('http://docs.python.org/3/', 'https://docs.python.org/3/objects.inv'),
                       ...
                       'pip_services4_container': ('https://pip-services4-python.github.io/pip-services4-container-python/',
                                                    'https://pip-services4-python.github.io/pip-services4-container-python/objects.inv'),
