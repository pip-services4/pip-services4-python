...
class MqttConnection(IMessageQueueConnection, IReferenceable, IConfigurable, IOpenable):
    ...
    ### References ###
        ...
        - `*:logger:*:*:1.0`             (optional) :class:`ICounters <pip_services4_components.log.ILogger.ILogger>` components to pass log messages
        ...
        - `*:discovery:*:*:1.0`          (optional) :class:`IDiscovery <pip_services4_components.connect.IDiscovery.IDiscovery>` services to resolve connections
