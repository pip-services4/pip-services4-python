...
from test.controllers.DummyLambdaFunction import DummyLambdaFunction

DUMMY1: Dummy = Dummy(None, 'Key 1', 'Content 1')
DUMMY2: Dummy = Dummy(None, 'Key 2', 'Content 2')


class TestDummyCommandableLambdaController:
    ...
    def setup_class(cls):
        config = ConfigParams.from_tuples(
            ...
            'controller.descriptor', 'pip-services-dummies:controller:commandable-lambda:default:1.0'
        )
